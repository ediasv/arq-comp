...
| 31       | BVS 6              | `000_0000_0110_1000` |
| 37       | LD R0, 3           | `000_0000_0011_0101` |
| 38       | MV A, R0           | `000_1000_0000_0100` |
| 39       | LD R1, 100         | `000_1110_0100_0101` |
| 40       | SW A, R1           | `000_1000_0001_1011` |
| 41       | LW R5, A           | `000_0101_1000_1010` |
| 42       | JMP 10             | `000_0000_1010_0110` |
